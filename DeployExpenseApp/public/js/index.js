...
window.addEventListener("DOMContentLoaded", () => {
  ...
  .then((response) => {
    ...
    // addNewExpenseToUi(res.data.expenses);
...
function showPagination({
  ...
  btnLastPage.innerHTML = `${lastPage}`;
  btnLastPage.addEventListener('click', () => getExpenses(lastPage));
  pagination.appendChild(btnLastPage);
